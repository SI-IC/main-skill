...
function main(p) {
  ...
  const reasonD = [
    ...
    "  операционные shell-скрипты (install/deploy/bootstrap/setup/provision/teardown/sync-config.sh),",
    ...
    "  D на проект через IGNORE_GLOBS на каталог исходников или VERIFY_CHANGES=0.",
    "Опт-аут целиком: MAIN_SKILL_VERIFY_CHANGES=0",
    "Per-project ignore (для config/ deploy/ legacy-каталогов ИЛИ репо с централизованными",
    "  тестами; НЕ для компонентов с логикой, у которых теста реально нет):",
